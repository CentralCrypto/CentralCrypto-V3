...
export const Navbar: React.FC<NavbarProps> = ({ 
  ...
  return (
    <nav className="fixed top-[142px] w-full z-40 bg-gray-50 dark:bg-[#1a1c1e] border-b border-transparent dark:border-tech-800 shadow-sm transition-colors duration-700 ease-in-out">
