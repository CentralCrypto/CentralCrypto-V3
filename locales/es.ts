...
export const es = {
    ...
    dashboard: {
        ...
        widgets: {
            ...
            gainers: { title: "Top Movers", gainers: "Alzas", losers: "Bajas" },
        ...
        magazine: {
            ...
            // Fixed typo on line 49: mini Boletines -> miniBulletins
    ...
    indicators: {
        ...
        details: { back: "Volver", strategy: "Estratégia", indicator: "Indicator", updated: "Atualizado recientemente", openTv: "Abrir en TV", disclaimerTitle: "Aviso Legal", disclaimerText: "El trading conlleva riesgos.", boosts: "Boosts", type: "Tipo", version: "Versión", access: "Acceso", getAccess: "Obtener Acceso", addFavDesc: "Añadir a favoritos en", btnAddFav: "Añadir a Favoritos", boostThanks: "¡Gracias por el boost!", boostLink: "Ver en TradingView" },
        vipModal: { title: "Solicitar Acesso VIP", successTitle: "Solicitud Enviada", successDesc: "Nos pondremos en contacto.", btnGo: "Ok", labelName: "Nombre", placeholderName: "Su nombre", labelUser: "Usuario TV", placeholderUser: "Su ID en TradingView", btnSubmit: "Enviar", btnSending: "Enviando..." },
    ...
    workspace: {
        ...
        widgets: {
            ...
            gainers: { title: "Top Movers", desc: "Top 100 monedas con mayores variações.", gainers: "Alzas", losers: "Bajas" },
            ...
            heatmap: { title: "Crypto Heatmap", desc: "Visualización en bloques (Treemap) del mercado cripto. Agrupado por categorías y dimensionado por Market Cap o Volume 24h.", modeCap: "Cap. Mercado", modeVol: "Volumen 24h", price: "Precio", change: "Variación", noData: "Datos de heatmap no disponibles" },
            ...
            // Fixed typo on line 102: extreme Fear -> extremeFear
            sentiment: { title: "Sentimiento Técnico", desc: "Sentimiento del mercado basado en indicadores técnicos (RSI).", extremeGreed: "Euforia", greed: "Codicia", extremeFear: "Pánico", fear: "Miedo", strong: "Forte", weak: "Débil", consistent: "Consistente", easing: "Disminuyendo", recovering: "Recuperando", neutralBiasUp: "Neutral (Alcista)", neutralBiasDown: "Neutral (Bajista)" },
